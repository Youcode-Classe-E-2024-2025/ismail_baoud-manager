          ...
          <div class="owl-carousel owl-banner">
              ...
              <div class="header-text">
                ...
                <div class="buttons">
                  ...
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-play"></i> What's RNVous?</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item item-2">
              <div class="header-text">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad nostrum quos libero dicta maxime voluptates magnam accusantium reprehenderit natus dolor!.</p>
                <div class="buttons">
                  <div class="main-button">
                    <a href="#">Request Demo</a>
                  </div>
